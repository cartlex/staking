...
contract ERC1155 is ERC165, IERC1155, IERC1155MetadataURI {
    ...
    function balanceOf(address account, uint id) public virtual view returns(uint) {
    ...
    function _safeTransferFrom(
        ...
        uint[] memory ids = _asSigngletonArray(id);
        uint[] memory amounts = _asSigngletonArray(amount);
    ...
    function _asSigngletonArray(uint el) private pure returns(uint[] memory result) {
        result = new uint[](1);
        result[0] = el;
    }
}