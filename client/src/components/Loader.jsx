const Loader = () => {
  return (
    <div class="flex items-center justify-center space-x-2 mt-20">
      <div
        class="inline-block h-[40px] w-[40px] animate-spin rounded-full border-4 border-solid border-current border-r-transparent align-[-0.125em] motion-reduce:animate-[spin_1.5s_linear_infinite]"
        role="status"
      >
