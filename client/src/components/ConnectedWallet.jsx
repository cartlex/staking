...
const ConnectedWallet = ({ address, handleWalletConnectClick }) => {
  return address ? (
    <div className="flex justify-center flex-col items-center">
      <h1 className="outline-none rounded-[10px] text-center placeholder:text-gray-500 bg-white text-zinc-700 w-[150px] h-[27px] hover:bg-slate-100 border-[1px] border-cyan-500 my-[3px] mr-[25px] flex items-center justify-center text-[14px]">
